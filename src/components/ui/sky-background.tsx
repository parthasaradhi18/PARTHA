...
export function SkyBackground() {
    ...
    return (
        <>
            {/* Stars background remains fixed */}
            ...
            {/* Glowing Moon on the left side (Absolute so it scrolls out of view below the hero section) */}
            <div className="absolute top-0 w-full h-screen pointer-events-none overflow-hidden" style={{ zIndex: -5 }}>
